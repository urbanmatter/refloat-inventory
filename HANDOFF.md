...
**Lokal fertig, Deploy nach Freigabe:** Phase 9 Schnellere Erfassung — Glas-Gruppen (geteilter Aufbau) + Maßtabelle (jede Zeile = ein Bestand-Eintrag), minimiert wiederholte Eingaben bei vielen ähnlichen Positionen. Implementiert und im statischen Preview verifiziert (siehe Abschnitt „Schnellere Erfassung: Glas-Gruppen mit Maßtabelle (Phase 9)"); **noch nicht committet/deployed** — wartet auf `git push` zur GitHub-Pages-Auslieferung.
